#!/bin/bash
# ---
# git_url: https://git.kernel.org/pub/scm/network/iproute2/iproute2-next.git
# git_commit: e8e8f16ed155dfbe026ad3c22458d1277e17794e
# other_files:
#   - 0001-rdma-Fix-owner-name-for-the-kernel-resources.patch
#   - 0002-rdma-Properly-print-device-and-link-names-in-CLI-out.patch

patch -p1 < /opt/0001*.patch
patch -p1 < /opt/0002*.patch

cat <<EOF > iproute2.spec
...
rpmbuild --build-in-place -bb iproute2.spec
